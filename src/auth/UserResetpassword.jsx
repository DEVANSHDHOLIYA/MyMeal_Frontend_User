...
const ResetPassword = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const res = await axios.post(`${BACKEND_URL}/auth/user/changepassword`, data);
    ...
    <div className="h-screen bg-white font-sans flex items-center justify-center px-4 overflow-hidden">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-[10px] text-slate-400 font-medium mt-0.5">Reset your password</p>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-7 shadow-[0_4px_24px_rgba(15,23,42,0.06)]">
          ...
          <div className="mb-6 pb-5 border-b border-slate-100">
            <h2 className="text-sm font-bold text-slate-900">Set New Password</h2>
            <p className="text-[10px] text-slate-400 mt-0.5">Enter your OTP and choose a new password</p>
          </div>
